...
from tensorflow.keras.layers import Input, Flatten, Dense, Conv2DTranspose, Lambda, Activation, BatchNormalization, \
    LeakyReLU, Reshape, Concatenate, Conv3D
...
class MuseGAN():
    ...
    def _build_adversarial(self):
        ...
        self.partial_gp_loss.__name__ = 'gradient_penalty'  # tensorflow.keras requires function names
